                  ...
                  <h1 class="mb-0 h3">Registrasi Akun Anda</h1>
								...
								@if($errors->any())
									<div class="alert alert-danger" role="alert">
											...
											<h4 class="alert-heading">Opps Something went wrong!</h4>
											<hr>
											<ol>
																		...
																		<div class="col-12 mb-4">
																			<div class="card card-body border-0 shadow mb-4">
																					<div class="mb-3">
																						...
																						<select class="form-select @error('id_warga_rutan') is-invalid @enderror" name="id_warga_rutan" id="select-warga">
