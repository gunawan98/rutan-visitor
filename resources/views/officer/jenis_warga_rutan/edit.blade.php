...
@section('title','Admin - Jenis Warga Rutan')
...
<div class="py-4">
		<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
				<ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
						...
						<li class="breadcrumb-item active"><a href="{{route('officer.jenis_warga_rutan.index')}}">Jenis Warga Rutan</a></li>
						<li class="breadcrumb-item active" aria-current="page">Edit</li>
				</ol>
		</nav>
		<div class="d-flex justify-content-between w-100 flex-wrap">
				<div class="mb-3 mb-lg-0">
						<h1 class="h4">Jenis Warga Rutan</h1>
				</div>
		</div>
</div>
								...
								<div class="card-body">     
										<div class="row mb-4">
												<div class="col-lg-12 col-sm-12">
													<form action="{{route('officer.jenis_warga_rutan.update', $data->id_jenis_warga_rutan)}}" method="post">
														@csrf
														@method('put')
														<div class="mb-3">
																<label for="nama_jenis">Jenis Warga Rutan</label>
																<div class="input-group">
																		...
																		<input type="text" class="form-control @error('nama_jenis') is-invalid @enderror" name="nama_jenis" value="{{ $data->nama_jenis }}" aria-label="nama_jenis">
																		@error('nama_jenis')
