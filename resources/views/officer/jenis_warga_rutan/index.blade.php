...
<div class="py-4">
		<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
				<ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
						...
						<li class="breadcrumb-item active" aria-current="page">Jenis Warga Rutan</li>
				</ol>
		</nav>
		<div class="d-flex justify-content-between w-100 flex-wrap">
				...
				<div class="text-end">
					<a href="{{route('officer.jenis_warga_rutan.create')}}">
						...
						<table class="table table-centered table-nowrap mb-0 rounded">
								<thead class="thead-light">
										<tr>
												...
												<th class="border-0">Jenis Warga Rutan</th>
												<th class="border-0">Status</th>
												<th class="border-0"></th>
										</tr>
								</thead>
								<tbody>
									@foreach ($jenis_warga_rutan as $data)
									<tr>
											...
											<td>
												<a href="{{route('officer.jenis_warga_rutan.edit', $data->id_jenis_warga_rutan)}}">
													<button type="button" class="btn btn-sm btn-secondary d-inline-flex align-items-center">
