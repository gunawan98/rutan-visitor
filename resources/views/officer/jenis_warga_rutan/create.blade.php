								...
								<div class="card-body">     
										<div class="row mb-4">
												<div class="col-lg-12 col-sm-12">
													<form action="{{route('officer.jenis_warga_rutan.store')}}" method="post">
														@csrf
														...
														<div class="mb-3">
																...
																<div class="input-group">
																		...
																		<input type="text" class="form-control @error('nama_jenis') is-invalid @enderror" name="nama_jenis" value="{{ old('nama_jenis') }}" aria-label="nama_jenis">
																		@error('nama_jenis')
