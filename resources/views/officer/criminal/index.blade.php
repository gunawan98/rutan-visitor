...
@section('title','Admin - Manajemen Data Kriminal')
...
<div class="py-4">
		<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
				<ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
						...
						<li class="breadcrumb-item active" aria-current="page">Data Kriminal</li>
				</ol>
		</nav>
		<div class="d-flex justify-content-between w-100 flex-wrap">
				<div class="mb-3 mb-lg-0">
						<h1 class="h4">Pangkalan Data Kriminal Rutan</h1>
						<p class="mb-0">Tekan tombol detail untuk melihat secara rinci pada masing-masing data.</p>
				</div>
		</div>
</div>
