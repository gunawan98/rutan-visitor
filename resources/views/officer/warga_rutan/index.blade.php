...
@section('title','Admin - Manajemen Data Warga Rutan')
...
<div class="py-4">
		<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
				<ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
						...
						<li class="breadcrumb-item active" aria-current="page">Warga Rutan</li>
				</ol>
		</nav>
		<div class="d-flex justify-content-between w-100 flex-wrap">
				<div class="mb-3 mb-lg-0">
						<h1 class="h4">Informasi Warga Rutan</h1>
						<p class="mb-0">Klik tombol tambah untuk menambahkan Warga Rutan.</p>
				</div>

				<div class="text-end">
					<a href="{{route('officer.warga_rutan.create')}}">
								...
								<tbody>
									...
									<tr>
											...
											<td class="text-success">
												<a href="{{route('officer.warga_rutan.edit', $data->id_warga_rutan)}}">
													<button type="button" class="btn btn-sm btn-secondary d-inline-flex align-items-center">
															<svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
															Edit
													</button>
												</a>
												<!-- <button type="button" class="btn btn-danger btn-sm" onclick="deleteItem(this)" data-id="{{ $data->id_warga_rutan }}">
			...
			swalWithBootstrapButtons.fire({
					...
					if (result.value) {
							if (result.isConfirmed){
									...
									$.ajax({
											type:'DELETE',
											url:'{{url("officer/data/warga_rutan")}}/'+id,
											data:{
													"_token": "{{ csrf_token() }}",
											},
											success:function(data) {
													if (data.success){
															...
															.then(function() {
																window.location.href = "/officer/data/warga_rutan";
															});
													}
