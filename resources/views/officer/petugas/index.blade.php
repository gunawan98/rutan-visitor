...
@section('title','Admin - Manajemen Data Petugas')
...
<div class="py-4">
		...
		<div class="d-flex justify-content-between w-100 flex-wrap">
				<div class="mb-3 mb-lg-0">
						<h1 class="h4">Informasi Petugas</h1>
						<p class="mb-0">Klik tombol tambah untuk menambahkan petugas.</p>
				</div>

				<div class="text-end">
					<a href="{{route('officer.petugas.create')}}">
			...
			swalWithBootstrapButtons.fire({
					...
					if (result.value) {
							if (result.isConfirmed){
									...
									$.ajax({
											type:'DELETE',
											url:'{{url("officer/data/petugas")}}/'+id,
											data:{
													"_token": "{{ csrf_token() }}",
											},
											success:function(data) {
													if (data.success){
															...
															.then(function() {
																window.location.href = "/officer/data/petugas";
															});
													}
