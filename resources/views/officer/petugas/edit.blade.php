...
@section('title','Admin - Edit Data Petugas')
...
<div class="py-4">
		...
		<div class="d-flex justify-content-between w-100 flex-wrap">
				<div class="mb-3 mb-lg-0">
						<h1 class="h4">Edit Data Petugas</h1>
				</div>
		</div>
</div>
								...
								<div class="card-body">     
										<div class="row mb-4">
												<div class="col-lg-12 col-sm-12">
													<form action="{{route('officer.petugas.update', $data->id)}}" method="post">
														@csrf
														@method('put')
														<div class="mb-3">
														...
														<div class="mb-3">
																...
																<div class="input-group">
																		...
																		<input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $data->email }}" aria-label="email">
																		@error('email')
																		<div class="invalid-feedback">{{ $message }}</div>
																		@enderror
																</div>
