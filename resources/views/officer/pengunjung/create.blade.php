...
@section('title','Admin - Tambah Data Pengunjung')
...
<div class="py-4">
		...
		<div class="d-flex justify-content-between w-100 flex-wrap">
				<div class="mb-3 mb-lg-0">
						<h1 class="h4">Tambah Data Pengunjung</h1>
				</div>
		</div>
</div>
								...
								<div class="card-body">     
										<div class="row mb-4">
												<div class="col-lg-12 col-sm-12">
													<form action="{{route('officer.pengunjung.store')}}" method="post" enctype="multipart/form-data">
														@csrf
														<div class="mb-3">
